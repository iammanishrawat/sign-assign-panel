    ...
    return (
        <>
            <div className="clickable-area">
                <button type="button" className={activeTab === 'profile' ? 'active' : ''}
                    onClick={() => setActiveTab('profile')}>
                    <img src={activeTab === 'profile' ? userIcon : user2Icon} alt="" />
                    My Profile
                </button>
                <button type="button" className={activeTab === 'password' ? 'active' : ''}
                ...
                <form action="" id="myProfileForm">
                    <div className="form-inner">
                        <div className="form-group">
                            ...
                            <input type="text" className="w-full" defaultValue="Gaurav" readOnly={!editMode} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="">Last Name <span>*</span></label>
                            <input type="text" className="w-full" defaultValue="Mittal" readOnly={!editMode} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="">Cell Phone Number <span>*</span></label>
                            <input type="text" className="w-full" defaultValue="+9199999999" readOnly={!editMode} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="">Email Address <span>*</span></label>
                            <input type="text" className="w-full" defaultValue="gaurav@gmail.com" readOnly={!editMode} />
                        </div>
                    </div>
            ...
            {activeTab === 'password' && (
                <form action="" id="changeMyPasswordForm">
                    <div className="form-inner" id="threeColLayout">
                        <div className="form-group">
                            <label htmlFor="">Current Password <span>*</span></label>
                            <input type="password" className="w-full" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="">New Password <span>*</span></label>
                            <input type="password" className="w-full" />
                        </div>
                        <div className="form-group">
                    ...
                    <div className="password-norms-area">
                        ...
                        <h6><Icons name='CircleArrowRight' /> Password must have at least 6 characters.</h6>
                    </div>
                    <div className="button-group">
