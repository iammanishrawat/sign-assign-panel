        ...
        <div className="form-inner">
          <div className="form-group">
            ...
            <input
              type="text"
              className="w-full"
              defaultValue={businessClient?.firstName}
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              className="w-full"
              defaultValue={businessClient?.lastName}
        ...
        <div className="form-inner">
          <div className="form-group">
            ...
            <input
              type="text"
              className="w-full"
              defaultValue={businessClient?.pinCode}
              onChange={e => onHandleChange("pinCode", e.target.value ?? "")}
            />
          </div>
          <div className="form-group">
            <label>
