...
export const createUserAddress = createAsyncThunk('userAddress/createUserAddress', async (payload: CreateUserAddressPayload, {rejectWithValue}) => {
    try {
...
export const updateUserAddress = createAsyncThunk('userAddress/updateUserAddress', async (payload: UpdateUserAddressPayload, {rejectWithValue}) => {
    try {
...
export const deleteUserAddress = createAsyncThunk('userAddress/deleteUserAddress', async (payload: DeleteUserAddressPayload, {rejectWithValue}) => {
    try {
